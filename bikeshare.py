...
def get_filters():
    ...
    while True:
      ...
      if city not in ('Chicago', 'chicago', 'New York City', 'new york city', 'Washington', 'washington'):
        print("Invalid enter Choose a city from (Chicago, New York City, Washington)")
        continue
      else:
        break
    ...
    while True:
      month = input("\n Choose a month or all: All, January, February, March, April, May, June \n")
      if month not in ('All', 'all', 'January', 'january', 'February', 'february', 'March', 'march', 'April', 'april', 'May', 'may', 'June', 'june'):
        print("Invalid enter Choose a month or all from (January, February, March, April, May, June)")
        continue
      else:
        break
    ...
    while True:
      day = input("\n Choose a day or all: All, Monday, Tuesday, Wednesday, Thursday, Friday, Saturday, Sunday \n")
      if day not in ('All', 'all', 'Monday', 'monday', 'Tuesday', 'tuesday', 'Wednesday', 'wednesday', 'Thursday', 'thursday', 'Friday', 'friday', 'Saturday', 'saturday', 'Sunday', 'sunday'):
        print("Invalid enter Choose a day or all from (Monday, Tuesday, Wednesday, Thursday, Friday, Saturday, Sunday)")
        continue
      else:
        break
...
def station_stats(df):
    ...
    print('most commonly used', Start, 'Stations')
...
def user_stats(df):
    ...
    if 'Birth Year' in CITY_DATA:
        ...
        print("common", df['Birth Year'].value_counts())
    else:
